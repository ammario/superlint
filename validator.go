...
type ValidatorFunc func(files map[string]*os.File, report ReportFunc) error
...
type SingleValidator func(f *os.File, report ReportFunc) error

// Single forms a new SingleValidator.
func Single(vf SingleValidator) ValidatorFunc {
	return func(files map[string]*os.File, report ReportFunc) error {
